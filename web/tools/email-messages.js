...
const ACCOUNT = 'http://localhost:3000/';
...
var messages = {
    ...
    registration: function(user){
        return '<div class="wizeUp-wrapper" style="width:60vw;margin:auto;padding:2vw;border-bottom: 1px solid rgba(199, 167, 104, 0.4);"> <div class="wizeUp-title" style="text-align:center;font-size:30px;font-weight:bold;color:#0E5D7C;margin-bottom:15px">Welcome To wizeUp </div></br>' +
            ...
            '<a class="no-decoration" style="text-decoration: none;" href="' + ACCOUNT +'"><div class="wizeUp-action-button" style="text-decoration: none;padding: 15px;color: white;text-align: center;margin: auto;background-color:#0E5D7C;width: 230px;margin-top: 20px;font-size: 20px; border-radius: 5px;">Go To wizeUp</div></a>' +
            '</div>' + SIGNITURE + STYLE
    },
